...
export default function Navigation() {
  ...
  const links = [
    ...
    { 
      to: '/create-trip', 
      icon: <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4"/></svg>
    },
    { 
      to: '/trips', 
