    ...
    <div className="text-center">
      ...
      {!isDone && (
        <div className="mb-4 space-y-2">
          <div className={`inline-flex items-center gap-3 px-6 py-3 rounded-2xl font-bold text-lg shadow-md transition-colors ${
            passing ? 'bg-green-500 text-white' : 'bg-blue-600 text-white animate-pulse'
          }`}>
      ...
      <div className="flex justify-center gap-2 flex-wrap mb-3">
        {STEPS.map((s, i) => {
          ...
          return (
            <div key={s.id} className={`px-4 py-2 rounded-full text-sm font-semibold border-2 transition-all ${
