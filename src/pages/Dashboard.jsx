        ...
        <main className="flex-1 w-full px-4 py-4 pb-32 max-w-md mx-auto flex flex-col">
          ...
          <form onSubmit={handleCreateTrip} className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-[2rem] p-5 mb-6 shadow-2xl z-20 relative">
            ...
            <button
              ...
              className="mt-4 w-full bg-[#eae0c8] text-[#0B132B] font-extrabold text-base py-3.5 rounded-xl hover:bg-white hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(234,224,200,0.3)] transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:hover:scale-100 disabled:hover:shadow-none"
            >
