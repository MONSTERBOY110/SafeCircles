...
export default function ScrollFrameSequence({
  ...
  // Gate the preload behind an IntersectionObserver: don't fetch hundreds of
  // frames simultaneously across all sequences on first paint. Each section
  // only preloads when it gets within ~1 viewport of the screen.
  ...
  // Trigger preload when the section is within one viewport of the user.
  useEffect(() => {
